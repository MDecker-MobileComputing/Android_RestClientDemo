...
public class BildActivity extends AppCompatActivity {
    ...
    /**
     * Event-Handler für Zufalls-Button.
     * Ruf zuerst {@link #setzeZufallsBildNr()} auf und
     * dann die Methode {@link #onStartButtonBetaetigt(View)}.
     */
        ...
        if (_bildNummer < 0 || _bildNummer > 99) {
            ...
            _startButton.post( new Runnable() {
                ...
                public void run() {
                    ...
                    Toast.makeText(BildActivity.this,
    ...
    protected void bildDarstellen(InputStream inputStream) throws IOException {
        ...
        if (bitmap == null) {
            ...
            Log.i(TAG4LOGGING, "Bitmap dekodiert, Höhe=" + bitmap.getHeight() +
                    ", Breite=" + bitmap.getWidth() );
